...
class Config(object):
    ...
    POOL = PooledDB(creator=MySQLdb, mincached=1, maxcached=20,
                    ...
                    db=DBNAME, use_unicode=False, charset=DBCHAR, cursorclass=DictCursor)
...
class Mysql(object):
    ...
    def getConn(self):
        return self._config.POOL.connection()
...
if __name__ == '__main__':
    mysql = Mysql(Config)
    result= mysql.getOne("select * from tbl_evaluate_tasks limit 1")
    print result